...
namespace Burn_Out.Migrations
{
    ...
    [Migration("20260119205033_AddPhoneNumberToRegister2")]
    partial class AddPhoneNumberToRegister2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.HallModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.HallReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("WhenReserved")
                        .HasColumnType("datetime2");
                    ...
                    b.HasDiscriminator().HasValue("HallReservation");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("Core.Models.PresenceHistoryModel", b =>
                {
            ...
            modelBuilder.Entity("Infrastructure.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastPresent")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Core.Models.HallReservation", b =>
                {
                    b.HasOne("Core.Models.HallModel", "Hall")
                        .WithMany()
